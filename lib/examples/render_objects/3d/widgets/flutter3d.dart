...
class RenderSpace extends RenderCube
  ...
  void paint(PaintingContext context, Offset shift) {
    ...
    while (child != null) {
      ...
      context.paintChild(
          child, shift); //child gets location by itself, just pass the center
...
class SphereWidget extends LeafRenderObjectWidget {
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => RenderSphereFigure(
        size: volume,
        rotation: rotation,
        color: color,
      );
